					...
					<div id="resultadosPacientes">
						...
						<?php
                               foreach ($pacientes as $p) {
                                    ...
                                    echo "<td>" . "<a href='indexAjax.php?pid=". base64_encode("modalPaciente.php") . "&idPaciente=" . $p->getId() . "' data-toggle='modal' data-target='#modalPaciente' ><span class='fas fa-eye' data-toggle='tooltip' class='tooltipLink' data-placement='left' data-original-title='Ver Detalles' ></span> </a>
