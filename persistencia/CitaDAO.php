...
class CitaDAO {
    ...
    function CitaDAO($idcita="", $fecha="", $hora="", $medico_idmedico="", $paciente_idpaciente="", $consultorio_idconsultorio=""){
        $this -> idcita = $idcita;
        $this -> fecha = $fecha;
        $this -> hora = $hora;
    ...
    function registrar(){
        return "insert into cita
                (fecha, hora, medico_idmedico, paciente_idpaciente, consultorio_idconsultorio)
                values ('" . $this->fecha . "', '" . $this->hora . "', " . $this->medico_idmedico . ", " . $this->paciente_idpaciente . ", " . $this->consultorio_idconsultorio . ")";
    }
    ...
    function consultarTodos(){
        return "select idcita, fecha, hora, medico.nombre,  paciente.nombre,  consultorio.nombre
